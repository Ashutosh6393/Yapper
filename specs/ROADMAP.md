...
| 03 | [notes-dashboard](./03-notes-dashboard/design.md) | 02 | **in-progress** | Logged-in user creates / lists / opens / deletes their own notes via REST + "My Notes" UI; routes gated by auth |
