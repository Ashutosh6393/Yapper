...
| 01 | [database-package](./01-database-package/design.md) | 00 | not-started | `@yapper/db` exposes a typed Drizzle client; `drizzle-kit` migrations create `note`, `note_doc`, `note_collaborator`; insert/select round-trips |
