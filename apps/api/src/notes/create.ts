 ...
 * `id` against `createNoteArgsSchema` first (well-formed UUID). Server-authoritative: `owner_id` is the
 * session user; client ownership/timestamps beyond the id are never trusted.
 *
